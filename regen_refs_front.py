"""Regen front-view refs with correct body type (slender/elongated, NOT barrel/chubby)."""
...
# KEY FIX: idle/cand_0 is SLENDER/ELONGATED, not barrel/chubby!
# Rectangular body, long torso, relatively short legs, lean build
...
BODY = ('The body is SLENDER and ELONGATED with a LONG torso and relatively short legs, '
        'a typical young Golden Retriever puppy build that is still growing into its frame. '
        'NOT barrel-shaped, NOT chubby, NOT round. Lean and leggy. ')

prompts = {
    'surprised': ('A young Golden Retriever puppy with light golden-cream fluffy fur. '
                  + COAT +
                  ...
                  'It sits facing the camera with a wide-eyed startled surprised expression, '
                  'mouth slightly open, ears perked up, body slightly recoiled. '
                  + BODY +
                  'Pure white seamless studio background, soft even lighting, photorealistic.'),
    'wave': ('A young Golden Retriever puppy with light golden-cream fluffy fur. '
             + COAT +
             'The puppy wears a fitted pet vest: cream off-white stand-up collar with bright yellow '
             'inner lining, brown sherpa fleece lower body, black center zipper, yellow drawstring '
             'cords with black toggles, yellow webbing D-ring on back. '
             'It sits calmly facing the camera, raising one front paw beside its head in a friendly '
             'waving gesture, paw pad facing the viewer. '
             + BODY +
             'Pure white seamless studio background, soft even lighting, photorealistic.'),
    'pet': ('A young Golden Retriever puppy with light golden-cream fluffy fur. '
            + COAT +
            'The puppy wears a fitted pet vest: cream off-white stand-up collar with bright yellow '
            'inner lining, brown sherpa fleece lower body, black center zipper, yellow drawstring '
            'cords with black toggles, yellow webbing D-ring on back. '
            'It sits calmly in a gentle three-quarter view, eyes closed with a content happy '
            'expression, tail wagging. A human hand reaches in from above petting its head. '
            + BODY +
            'Pure white seamless studio background, soft even lighting, photorealistic.'),
    'kiss': ('A young Golden Retriever puppy with light golden-cream fluffy fur. '
             ...
             + BODY +
             'Pure white seamless studio background, soft even lighting, photorealistic.'),
    'beg': ('A young Golden Retriever puppy with light golden-cream fluffy fur. '
            + COAT +
            'The puppy wears a fitted pet vest: cream off-white stand-up collar with bright yellow '
            'inner lining, brown sherpa fleece lower body, black center zipper, yellow drawstring '
            'cords with black toggles, yellow webbing D-ring on back. '
            'It stands up on its hind legs, raising both front paws in a begging pose, '
...
for name, prompt in prompts.items():
    ...
    # rembg + scale to idle height + white canvas
    ...
    sub_w = right - left + 1
    aspect = sub_h / sub_w
    print(f'  raw: {sub_w}x{sub_h}, aspect={aspect:.2f}')

    # Scale to match idle's HEIGHT (433px) preserving aspect ratio
