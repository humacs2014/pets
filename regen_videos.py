...
REF_IMAGE = os.path.join(ROOT, 'identity_candidates', 'cand_1.png')  # 身份图铁律: 必须四腿站立+3/4身, 坐姿/趴姿身份图会带偏所有视频姿态; vision_pick 选定的认可图
...
NEG_BREED = ('adult dog, long silky fur, golden retriever, labrador, husky, gray fur, black fur, '
             'brown coat, floppy ears, droopy ears, skinny, thin')  # 品种/毛色排除词
# 毛色一致性子句（防 run 高速运动时毛色斑驳/色漂移）；新宠物按品种毛色改写
COAT_CLAUSE = ' The coat is clean uniform warm orange and cream fur with white chest markings on every part of the body.'
# ══════════ CONFIG END ══════════
