"""Regen kiss ref with explicit leg count constraint."""
...
BODY = ('The body is SLENDER and ELONGATED with a LONG torso and relatively short legs, '
        ...
        'The body ALWAYS has EXACTLY FOUR LEGS with correct anatomy: two front legs and two hind legs. ')
...
print('Generating kiss...', flush=True)
r = None
...
if not r or r.status_code != 200:
    ...
    d = r.json()
    item = d['data'][0]
    raw_path = 'identity_candidates/kiss_ref_raw.png'
    ...
    if len(ys) == 0:
        ...
        final_path = 'identity_candidates/kiss_ref.png'
