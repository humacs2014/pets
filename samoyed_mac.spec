...
# 占位符（全局替换）: samoyed_pet.py=主程序文件名  萨摩耶桌面宠物=宠物显示名(中文)  SamoyedDesktopPet=英文名  com.samoyeddesktoppet.pet=如com.user.catpet
a = Analysis(
    ['samoyed_pet.py'],
    pathex=[],
    binaries=[],
...
coll = BUNDLE(
    ...
    bundle_identifier='com.samoyeddesktoppet.pet',
    info_plist={
        'CFBundleDisplayName': '萨摩耶桌面宠物',
        'CFBundleName': 'SamoyedDesktopPet',
