...
# ═══ v66 参数化（换宠物改这里）═══
PET_NAME = '麻薯桌面宠物'            # 中文显示名（窗口前缀/单例提示）
PET_NAME_ASCII = 'MochiDesktopPet'   # 英文名（窗口标题/单例mutex）
BARK_TEXT, EAT_TEXT = '汪呜~', '好吃!'   # 气泡文字
...
ANIMS = {
    ...
    'type':      ('type',      49, 42,  True, 0),    # v118: 裁稳定段33-81=49帧闭环(去intro键盘跳变/手残影)@42≈2.06s
