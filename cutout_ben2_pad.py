# -*- coding: utf-8 -*-
"""cutout_ben2_pad.py — BEN2抠图，pad到128的倍数（满足所有内部约束），推理后裁回原始尺寸。
用法: python cutout_ben2_pad.py [state1 state2 ...]
"""
...
def run_ben2(raw_frames, out_dir):
    ...
    # BEN2约束：Swin window_size=12, patch_size=4, MCLM ng=nw=2
    # 需 H%128==0 且 W%128==0（H/64能被2整除 + Swin各stage都能整除）
    DIV = 128
