...
#  主窗口
# ═══════════════════════════════════════════════════════════
WINDOW_TITLE = 'GoldenDesktopPet_MainWindow'  # 固定窗口标题：供重复启动的新实例FindWindow定位并激活
...
def _acquire_single_instance():
    ...
    _singleton_mutex = kernel32.CreateMutexW(None, False, 'GoldenDesktopPetV1_Singleton')
