"""Regen kiss/beg/dance refs with leg constraint + better quality."""
...
BODY = ('The body is SLENDER and ELONGATED with a LONG torso and relatively short legs, '
        ...
        'CRITICAL: The body ALWAYS has EXACTLY FOUR LEGS with correct anatomy. '
        'NO extra legs, NO extra paws, NO deformed legs. ')

prompts = {
    'kiss': ('A young Golden Retriever puppy with light golden-cream fluffy fur standing on all four legs facing the camera. '
             + COAT +
             ...
             'It stands on four legs facing the camera with an affectionate expression, looking directly at the '
             'viewer with warm brown eyes, pink tongue slightly out. '
             'Four legs firmly on the ground. '
             + BODY +
    ...
    'beg': ('A young Golden Retriever puppy with light golden-cream fluffy fur. '
            ...
            'inner lining, brown sherpa fleece lower body, black center zipper, yellow drawstring '
            'cords with black toggles, yellow webbing D-ring on back. '
            'It stands up on its two hind legs, raising both front paws in a begging pose, '
            'looking up expectantly. Only two hind legs touch the ground. '
            'Two front paws raised in the air. Exactly four legs total. '
            + BODY +
            'Pure white seamless studio background, soft even lighting, photorealistic.'),
    'dance': ('A young Golden Retriever puppy with light golden-cream fluffy fur. '
              ...
              'in the air. Only two hind legs touch the ground. '
              'Two front paws raised. Exactly four legs total. '
              + BODY +
              'Pure white seamless studio background, soft even lighting, photorealistic.'),
}
